...
#### Libraries
* [ngx-store](https://github.com/zoomsphere/ngx-store) Library providing `@(Local|Session|Cookie)Storage` decorators and services that make it super easy to store your data
